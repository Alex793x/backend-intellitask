 ...
 *
 * @template T - The entity type returned by the repository (database model)
...
export abstract class BaseRepository<T, U> extends Singleton implements IBaseCRUD<T, U> {
  ...
  /**
   * Retrieves a single entity by its unique m
   ...
   */
  abstract updateOne(id: string, item: U): Promise<void | T>;
